...
\usepackage{easyReview} % Правки
\makeatletter
\newcommand{\currentfontsize}{\fontsize{\f@size}{\f@baselineskip}\selectfont}
\makeatother
\usepackage{fontspec,minted}
\newfontfamily\consolas{Courier New}[NFSSFamily=ArialFamily]
\setminted[python]{fontfamily=ArialFamily, fontsize=\currentfontsize}
\newfontfamily\consolascs{Courier New}[NFSSFamily=ArialFamily]
\setminted[csharp]{fontfamily=ArialFamily, fontsize=\currentfontsize, breaklines}
...
% Секции для аннотаций, чтоб не были видны в содержании
\newcommand{\annotsection}[1]{
